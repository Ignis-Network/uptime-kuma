...
```bash
docker run -d --restart=always -p 8085:8085 -v uptime-kuma:/app/data --name uptime-kuma louislam/uptime-kuma:1
```

Uptime Kuma is now running on http://localhost:8085
